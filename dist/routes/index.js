...
var adminEventController = _interopRequireWildcard(
  require("../controllers/admin/events/index")
);
var usersController = _interopRequireWildcard(
  require("../controllers/users/index")
);
var adminUserController = _interopRequireWildcard(
  require("../controllers/admin/users/index")
);
